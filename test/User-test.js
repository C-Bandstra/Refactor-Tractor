...
describe('User', function() {
  ...
  it('should have friends', function() {
    expect(user.friends).to.deep.equal([1, 2, 3])
  });
  ...
  it('calculateWeeklyAverage should calculate average sleep hours for week before given date', function() {
    user.sleepHoursRecord = [{date: "2019/09/22", hours: 7}, {date: "2019/09/21", hours: 7}, {date: "2019/09/20", hours: 7}, {date: "2019/09/19", hours: 7}, {date: "2019/09/18", hours: 7}, {date: "2019/09/17", hours: 7}, {date: "2019/09/16", hours: 7}];
    let date = "2019/09/22"
    expect(user.calculateWeeklyAverage(user.sleepHoursRecord, 'hours', date)).to.equal('7');
  });
  it('calculateAverageQualityThisWeek should calculate average quality of sleep for week before a given date', function() {
    user.sleepQualityRecord = [{date: "2019/09/22", quality: 7}, {date: "2019/09/21", quality: 7}, {date: "2019/09/20", quality: 7}, {date: "2019/09/19", quality: 7}, {date: "2019/09/18", quality: 7}, {date: "2019/09/17", quality: 7}, {date: "2019/09/16", quality: 7}];
    let date = "2019/09/22"
    expect(user.calculateWeeklyAverage(user.sleepQualityRecord, 'quality', date)).to.equal('7');
  });
  ...
  it('calculateWeeklyAverage should calculate the average minutes active', function() {
    user.activityRecord = [{date: "2019/09/18", minutesActive: 70}, {date: "2019/09/17", minutesActive: 70}, {date: "2019/09/16", minutesActive: 70}, {date: "2019/09/15", minutesActive: 70}, {date: "2019/09/14", minutesActive: 70}, {date: "2019/09/13", minutesActive: 70}, {date: "2019/06/12", minutesActive: 70}];
    let date = "2019/09/18"
    expect(user.calculateWeeklyAverage(user.activityRecord, 'minutesActive', date)).to.equal('70')
  });
  it('calculateWeeklyAverage should calculate the average steps taken in a given week', function() {
    user.activityRecord = [{date: "2019/09/18", steps: 70}, {date: "2019/09/17", steps: 70}, {date: "2019/09/16", steps: 70}, {date: "2019/09/15", steps: 70}, {date: "2019/09/14", steps: 70}, {date: "2019/09/13", steps: 70}, {date: "2019/06/12", steps: 70}];
    let date = "2019/09/18"
    expect(user.calculateWeeklyAverage(user.activityRecord, 'steps', date)).to.equal('70')
  });
  it('calculateWeeklyAverage should calculate the average flights of stairs taken in a given week', function() {
    user.activityRecord = [{date: "2019/09/18", flightsOfStairs: 7}, {date: "2019/09/17", flightsOfStairs: 7}, {date: "2019/09/16", flightsOfStairs: 7}, {date: "2019/09/15", flightsOfStairs: 7}, {date: "2019/09/14", flightsOfStairs: 7}, {date: "2019/09/13", flightsOfStairs: 7}, {date: "2019/06/12", flightsOfStairs: 7}];
    let date = "2019/09/18"
    expect(user.calculateWeeklyAverage(user.activityRecord, 'flightsOfStairs', date)).to.equal('7')
  });
  ...
  it('findTrendingStepDays should find 3+ days with positive trend', function() {
    ...
    user.findTrending("trendingStepDays", "steps", "step")
  ...
  it('findTrendingStairsDays should find 3+ days with positive trend', function() {
    user.activityRecord = [{
    "date": "2019/06/29", "flightsOfStairs": 18},
    {"date": "2019/06/28", "flightsOfStairs": 17},
    {"date": "2019/06/27", "flightsOfStairs": 16},
    {"date": "2019/06/26", "flightsOfStairs": 15},
    {"date": "2019/06/25", "flightsOfStairs": 1},
    {"date": "2019/06/24", "flightsOfStairs": 12},
    {"date": "2019/06/23", "flightsOfStairs": 11},
    ...
    user.findTrending('trendingStairsDays', 'flightsOfStairs', 'climbing');
  ...
  user4.activityRecord = [{
    ...
    expect(user.friendsActivityRecords).to.deep.equal([{"name": "John Firth", "steps": 734}, {"name": "Ben Nist", "steps": 248}, {"name": "Nick Adams", "steps": 34}]);
  });
});
